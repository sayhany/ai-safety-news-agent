...
from .processing.text_utils import clean_html_text
...
"""
    ...
    async def _extract_implications(self, article: dict, summary: str) -> str | None:
    ...
    async def summarize_article(self, article: dict,
                              config: SummaryConfig | None = None) -> ArticleSummary:
    ...
    async def summarize_articles(self, articles: list[dict],
                               config: SummaryConfig | None = None) -> list[dict]:
